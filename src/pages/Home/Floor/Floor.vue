            ...
            <div class="floor-1">
              ...
              <div class="split">
                ...
                <div class="floor-conver-pit">
                  <img :src="floor.recommendList[0]" style="width: 100%; height: 100%;"/>
                </div>
                <div class="floor-conver-pit">
                  <img :src="floor.recommendList[1]" style="width: 100%; height: 100%;"/>
                </div>
              </div>
              <div class="split center">
                <img :src="floor.bigImg"  style="width: 100%; height: 100%;"/>
              </div>
              <div class="split">
                <span class="floor-x-line"></span>
                <div class="floor-conver-pit">
                  <img :src="floor.recommendList[2]"  style="width: 100%; height: 100%;"/>
                </div>
                <div class="floor-conver-pit">
                  <img :src="floor.recommendList[3]" style="width: 100%; height: 100%;"/>
                </div>
              </div>
            </div>
          </div>
