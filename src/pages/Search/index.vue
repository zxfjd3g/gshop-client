      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li
              class="with-x"
              v-if="options.categoryName"
              @click="deleteCategory"
            >
              {{ options.categoryName }}<i>×</i>
            </li>
            <li class="with-x" v-if="options.keyword" @click="deleteKeyword">
              {{ options.keyword }}<i>×</i>
            </li>
            <li
              class="with-x"
        ...
        <div class="details clearfix">
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li
                class="yui3-u-1-5"
                v-for="good in productList.goodsList"
                :key="good.id"
              >
                <div class="list-wrap">
                  <div class="p-img">
