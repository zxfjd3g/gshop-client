...
*/
export const reqDiscountList = skuId => ajax.get(`/activity/findActivityAndCoupon/${skuId}`)

/*
16.领取优惠券
/api/activity/auth/getCouponInfo/{couponId} GET
*/
export const reqCouponInfo = couponId => ajax.get(`/activity/auth/getCouponInfo/${couponId}`)
...
*/
export const reqAddressBaseProvinceByRegionId = (regionId) => ajax.get(`/user/userAddress/auth/findBaseProvinceByRegionId/${regionId}`)
...
*/
export const reqSaveUserAddress = (userAddressInfo) => ajax.post(`/user/userAddress/auth/save`,userAddressInfo)

/*
21.删除用户地址
/api/user/userAddress/auth/delete/{userAddressId} GET
*/
export const reqRemoveUserAddress = (userAddressId) => ajax.get(`/user/userAddress/auth/delete/${userAddressId}`)

/*
22.更新用户地址
/api/user/userAddress/auth/update POST
*/
export const reqUpdateUserAddress = (userAddressId) => ajax.post(`/user/userAddress/auth/update`, userAddressId)

/*
23.获取订单商品详情详情
/api/order/auth/getOrderDetail/{orderDetailId} GET
*/
export const reqOrderDetail = (orderDetailId) => ajax.get(`/order/auth/getOrderDetail/${orderDetailId}`)
...
*/
export const orderRefund = (orderRefundInfo) => ajax.post(`/order/orderRefundInfo/auth/save`, orderRefundInfo)

/*
获取退货列表
/api/order/orderRefundInfo/auth/${page}/${limit}  GET
*/
export const getRefundList = (page, limit) => ajax.get(`/order/orderRefundInfo/auth/${page}/${limit}`)

/* 
退货后发货
GET /api/order/orderRefundInfo/auth/delevered/{id}/{trackingNo}
*/
export const delever = (id, trackingNo) => ajax.get(`/order/orderRefundInfo/auth/delevered/${id}/${trackingNo}`) 